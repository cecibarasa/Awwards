# Generated by Django 3.0.7 on 2020-07-12 11:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project', to='awwards.Profile')),
            ],
            options={
                'db_table': 'projects',
                'ordering': ['-id'],
        ...
        migrations.AddField(
            model_name='profile',
            name='all_projects',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='awwards.Project'),
        ),
        migrations.AddField(
            model_name='profile',
            name='user_profile',
